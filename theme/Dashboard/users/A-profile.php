            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3">
                            <label class="small mb-1" for="inputMerchantName">Admin Name</label>
                            <input class="form-control" id="inputMerchantName" type="text" placeholder="Enter your merchant name" value="Admin Name">
                        </div>
                        <!-- Form Row-->
